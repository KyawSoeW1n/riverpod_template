...
/// A class which mocks [PostsRemoteDataSourceImpl].
///
/// See the documentation for Mockito's code generation for more information.
class MockPostsRemoteDataSourceImpl extends _i1.Mock
    implements _i5.PostsRemoteDataSourceImpl {
  MockPostsRemoteDataSourceImpl() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockFetchPostsUseCase extends _i1.Mock implements _i7.FetchPostsUseCase {
